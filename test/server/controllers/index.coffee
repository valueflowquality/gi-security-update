...
module.exports = () ->
  describe 'Controllers', ->
    ...
    it 'exports user controller', (done) ->
      assert stubs['./user'].calledWith(app.models.users, app.controllers.crud)
    ...
    it 'exports activity controller', (done) ->
      assert stubs['./activity'].calledWith(
        app.models.activities, app.controllers.crud
      )
    ...
    it 'exports file controller', (done) ->
      assert stubs['./file'].calledWith(app.models, app.controllers.crud)
    ...
    it 'exports crud role controller', (done) ->
      assert app.controllers.crud.calledWith(app.models.roles)
    ...
    it 'exports crud setting controller', (done) ->
      assert app.controllers.crud.calledWith(app.models.settings)
    ...
    it 'exports crud category controller', (done) ->
      assert app.controllers.crud.calledWith(app.models.categories)
    ...
    it 'exports crud environment controller', (done) ->
      assert app.controllers.crud.calledWith(app.models.environments)
    ...
    it 'exports crud permission controller', (done) ->
      assert app.controllers.crud.calledWith(app.models.permissions)
    ...
    it 'exports crud resource controller', (done) ->
      assert app.controllers.crud.calledWith(app.models.resources)
