...
module.exports = () ->
  describe 'Activities', ->
    ...
    beforeEach (done) ->
      ...
      model = require(dir + '/models/activities')(mocks.dal)
      done()
    ...
    it 'Creates an Activity dal model', (done) ->
      expect(mocks.dal.model.calledWith('Activity'
    ...
    describe 'Schema', ->
      ...
      it 'timeStamp: Date default Date.now', (done) ->
        ...
        timestamp = moment(mocks.dal.model.args[0][1]
        .timeStamp.default())
